...
class TeamCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addFields([$image, $desc, $socail], 'update/create/both');
        $this->crud->addColumns([$imageCol, $descCol]);
        ...
        $this->crud->removeColumns(['social']); // remove an array of columns from the stack
